                                                ...
                                                <div class="form-group col-lg-6">
                                                    ...
                                                    <select class="select2_demo_1 form-control" name="link_redirect">
                                                        <?php foreach($collections as $collection): ?>
                                                            <option value="<?=$collection['name']?>" <?= ($collection['name'] == $data['link_redirect']) ? 'selected="selected"' : ""; ?>><?= $collection['name'] ?></option>
                                                        <?php endForeach ?>
                                                        <?php foreach($categories as $category): ?>
                                                            <option value="<?=$category['name']?>" <?= ($category['name'] == $data['link_redirect']) ? 'selected="selected"' : ""; ?>><?= $category['name'] ?></option>
                                                        <?php endForeach ?>
                                                    </select>

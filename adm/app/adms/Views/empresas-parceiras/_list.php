...
<?php include 'app/adms/Views/_includes/navbar.php';?>
				        ...
				        <div class="ibox float-e-margins">
				        	<?php if(!$error): ?>
					            <div class="ibox-title">
					                <h5>Listagem de empresas parceiras</h5>
						                ...
						                <table class="table table-bordered table-hover dataTables-example">
						                    ...
						                    <tbody>
				    							<?php foreach ($data as $item): ?>
				    								...
				    								<?php
				    									$image = ($item['image']) ? 'app/sts/assets/img/companies/' . $item['image'] : '';
								                    ...
								                    <tr class="gradeX">
								                        ...
								                        <td><?=$item['name']?></td>
								                        <td>
															<input type="hidden" name="company_id" value="<?= $item['id_company'] ?>">
								                        ...
								                        <td>
								                        	<input type="hidden" name="item_id" value="<?= $item['id_company'] ?>">
															<a href="<?= $this->pageEdit . '/' . $item['id_company']?>" class="btn btn-warning btn-m" title="Editar"><i class="fa fa-pencil"></i></a>
															<a href="<?= $this->pageDelete . '/' . $item['id_company']?>" class="btn btn-danger btn-m" onclick="return confirm('Deseja excluir esse registro?')" title="Excluir"><i class="fa fa-trash-o"></i></a>
								                        </td>
								                    </tr>
												<?php endforeach?>
						                    </tbody>
    ...
    <script src="<?= URLADM ?>app/adms/assets/js/pages/empresas-parceiras/empresas-parceiras-actions.js"></script>
